...
<i class="fa fa-dashboard" ></i> Dashboard / Others Breakdown
...
<h1 style="text-align: center;"><?php if(isset($_POST['monthly']) AND !empty($_POST['month'])) {
       echo $value = $cname.' '.mysqli_real_escape_string($con,$_POST['month']).", Others Income Breakdown";}else{
        if(isset($_POST['yearly']) AND !empty($_POST['year'])) {
       echo $value = $cname.' '.mysqli_real_escape_string($con,$_POST['year']).", Others Income Breakdown";
       }else{
        if(isset($_POST['dates']) AND !empty($_POST['date'])) {
       echo $value = $cname.' '.mysqli_real_escape_string($con,$_POST['date']).", Income Breakdown";
       }else{echo $cname.', '."Others Total Income Breakdown";} }}?></h1>
...
<th>Total Others</th>
<td style="text-align: center; background-color: brown; color: white;">&#8373;<?php echo $sum; ?></td>
...
<th><?php if (isset($_POST['monthly']) AND !empty($_POST['month'])) {
       ...
       echo $value = mysqli_real_escape_string($con,$_POST['year']);}} ?></th>
<th>Total CONF</th>
<td style="text-align: center; background-color: brown; color: white;">&#8373;<?php echo $sum/2; ?></td>
